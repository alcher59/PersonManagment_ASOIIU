...
namespace PersonManagment.Data.Migrations
{
    ...
    [Migration("20200916092729_fixSalaryAndAddEmployeeStaffingTable")]
    partial class fixSalaryAndAddEmployeeStaffingTable
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PersonManagment.Data.FilesInfo", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PersonManagment.Data.FilesInfoFilesData", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("PersonManagment.Data.FilesInfoFilesData", b =>
                {
                    b.HasOne("PersonManagment.Data.FilesData", "FilesData")
                        .WithMany("FilesInfoFilesData")
                        .HasForeignKey("filesDataId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PersonManagment.Data.FilesInfo", "FilesInfo")
                        .WithMany("FilesInfoFilesData")
            ...
            modelBuilder.Entity("PersonManagment.Data.StaffingTable", b =>
                {
                    ...
                    b.HasOne("PersonManagment.Data.Employee", "EmployeeAccept")
                        .WithMany("StaffingTableAccept")
                        .HasForeignKey("acceptEmployeeId");

                    b.HasOne("PersonManagment.Data.Employee", "EmployeeST")
